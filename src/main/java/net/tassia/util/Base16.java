...
public class Base16 {
	 ...
	 */
	public static char[] getUppercaseTable() {
	 ...
	 * @return the translation table
	 */
	public static char[] getLowercaseTable() {
		return "0123456789abcdef".toCharArray();
	}
	 ...
	 */
	public static char[] getDefaultTable() {
	 ...
	 * @return the encoded Base16 string
	 */
	public static String encode(String str, Charset ch) {
	...
	public static String encode(byte[] data) {
		StringBuilder sb = new StringBuilder((int) Math.ceil(data.length / 3D) * 4);
	 ...
	 */
	private static void encode(StringBuilder sb, byte[] data, char[] table) {
		for (byte datum : data) {
			encodeElement(sb, ((int) datum) & 0xff, table);
		}
	}
	 ...
	 * @param x the byte (as int)
	 * @param table the translation table to use
	 */
	private static void encodeElement(StringBuilder sb, int x, char[] table) {
	 ...
	 * @throws IllegalArgumentException if the string contains non-Base16 characters
	 */
	public static String decodeToString(String str, Charset ch) throws IllegalArgumentException {
	...
	public static byte[] decode(String str) throws IllegalArgumentException {
		...
		char[] table = getDefaultTable();
		if (str.length() % 2 != 0) throw new IllegalArgumentException("string length is not a multiple of two");
	 ...
	 */
	private static void decodeElement(byte[] buffer, int offset, char a, char b, char[] table) throws IllegalArgumentException {
	 ...
	 */
	private static byte decodeCharacter(char x, char[] table) throws IllegalArgumentException {
