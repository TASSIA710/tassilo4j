...
public final class Base64 {
	 ...
	 * @param table the translation table to use
	 */
	private static void encodeElement(StringBuilder sb, int a, int b, int c, char[] table) {
	...
	public static byte[] decode(String str) throws IllegalArgumentException {
		...
		while (strBuilder.length() % 4 != 0) strBuilder.append("=");
	 ...
	 */
	private static int decodeElement(byte[] buffer, int offset, char a, char b, char c, char d, char[] table) throws IllegalArgumentException {
